...
class SpriteImage_Sushi(SLib.SpriteImage_Static):
    def __init__(self, parent):
        super().__init__(
            parent,
            1.5,
...
#            parent,
#            1.5,
#            ImageCache['VolcanoLotus'],
#        )
#
#    @staticmethod
#    def loadImages():
#        SLib.loadIfNotInImageCache('VolcanoLotus', 'goombaTower.png')
...
ImageClasses = {
    ...
    # Horizon
    # 483: SpriteImage_PowerStar,
    484: SpriteImage_Sushi,
    # 485: SpriteImage_Goombrat,
    # 486: SpriteImage_EventCoin,
    # 487: SpriteImage_PathControlledEventCoin,
    # 488: SpriteImage_VanishPlatform,
    # 489: SpriteImage_LongBlock,
    # 490: SpriteImage_PlayerSpecificBlock,
    # 491: SpriteImage_BigCoin,
    # 492: SpriteImage_BouncyMushroom,
    # 493: SpriteImage_ShellSpawner,
    # 494: SpriteImage_MoneyBags,
    # 495: SpriteImage_3DWThwomp,
